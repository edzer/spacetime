...
[vignette](https://cran.r-project.org/web/packages/googleVis/vignettes/Using_googleVis_with_knitr.html)
...
vignette](https://cran.r-project.org/web/packages/spacetime/vignettes/sto.pdf)
